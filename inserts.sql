...
(1, (SELECT id_material FROM Material WHERE tipo = "Plástico"), '2025-09-20'),
(1, (SELECT id_material FROM Material WHERE tipo = "Papel"), '2025-09-20'),
(2, (SELECT id_material FROM Material WHERE tipo = "Metal"), '2025-09-21'),
(2, (SELECT id_material FROM Material WHERE tipo = "Vidro"), '2025-09-21'),
(3, (SELECT id_material FROM Material WHERE tipo = "Orgânico"), '2025-09-22'),
(4, (SELECT id_material FROM Material WHERE tipo = "Plástico"), '2025-09-22'),
(4, (SELECT id_material FROM Material WHERE tipo = "Metal"), '2025-09-23'),
(5, (SELECT id_material FROM Material WHERE tipo = "Papel"), '2025-09-23'),
(5, (SELECT id_material FROM Material WHERE tipo = "Vidro"), '2025-09-24'),
(5, (SELECT id_material FROM Material WHERE tipo = "Orgânico"), '2025-09-24');
...
((SELECT id_fornecedor FROM FORNECEDOR WHERE id_fornecedor='FOR-2025-3253'), 
(SELECT id_material FROM MATERIAL WHERE id_material='MAT-PLÁ-9968'), 
(SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-484")),

((SELECT id_fornecedor FROM FORNECEDOR WHERE id_fornecedor='FOR-2025-3253'), 
(SELECT id_material FROM MATERIAL WHERE id_material='MAT-PAP-3413'), 
(SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-484")),

((SELECT id_fornecedor FROM FORNECEDOR WHERE id_fornecedor='FOR-2025-2633'), 
(SELECT id_material FROM MATERIAL WHERE id_material='MAT-MET-7158'), 
(SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-535")),

((SELECT id_fornecedor FROM FORNECEDOR WHERE id_fornecedor='FOR-2025-2633'), 
(SELECT id_material FROM MATERIAL WHERE id_material='MAT-VID-5556'), 
(SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-535")),

((SELECT id_fornecedor FROM FORNECEDOR WHERE id_fornecedor='FOR-2025-3408'), 
(SELECT id_material FROM MATERIAL WHERE id_material='MAT-ORG-6304'), 
(SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-222")),

((SELECT id_fornecedor FROM FORNECEDOR WHERE id_fornecedor='FOR-2025-9139'),
(SELECT id_material FROM MATERIAL WHERE id_material='MAT-PLÁ-9968'), 
(SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-504")),

((SELECT id_fornecedor FROM FORNECEDOR WHERE id_fornecedor='FOR-2025-9139'), 
(SELECT id_material FROM MATERIAL WHERE id_material='MAT-MET-7158'), 
(SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-504")),

((SELECT id_fornecedor FROM FORNECEDOR WHERE id_fornecedor='FOR-2025-5477'), 
(SELECT id_material FROM MATERIAL WHERE id_material='MAT-PAP-3413'), 
(SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-855")),
...
((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-484"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-PLÁ-9968"), 
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "COL-2025-5764"), 100),

((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-484"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-PAP-3413"), 
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "COL-2025-5764"), 200),

((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-535"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-MET-7158"), 
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "SEP-2025-6260"), 150), 

((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-535"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-VID-5556"), 
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "SEP-2025-6260"), 80),

((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-222"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-ORG-6304"), 
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "ATE-2025-4010"), 50), 

((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-504"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-PLÁ-9968"), 
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "COL-2025-5764"), 120),

((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-504"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-MET-7158"), 
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "COL-2025-5764"), 90),

((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-855"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-PAP-3413"), 
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "MOT-2025-1270"), 60),

((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-855"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-VID-5556"),
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "MOT-2025-1270"), 70),

((SELECT id_doc_coleta FROM Documento_Coleta WHERE id_doc_coleta = "COL-251031-855"), 
(SELECT id_material FROM Material WHERE id_material = "MAT-ORG-6304"), 
(SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "MOT-2025-1270"), 40);
...
((SELECT id_doc_venda FROM DOCUMENTO_VENDA WHERE id_doc_venda='VEN-251031-089'), 
(SELECT id_material FROM Material WHERE id_material = "MAT-MET-7158"), 
60, 5.00),
...
((SELECT id_doc_venda FROM DOCUMENTO_VENDA WHERE id_doc_venda='VEN-251031-097'), 
(SELECT id_material FROM Material WHERE id_material = "MAT-ORG-6304"), 
50, 0.80),
...
((SELECT id_doc_venda FROM DOCUMENTO_VENDA WHERE id_doc_venda='VEN-251031-221'), 
(SELECT id_material FROM Material WHERE id_material = "MAT-MET-7158"), 
50, 5.00),

((SELECT id_doc_venda FROM DOCUMENTO_VENDA WHERE id_doc_venda='VEN-251031-812'), 
(SELECT id_material FROM Material WHERE id_material = "MAT-PAP-3413"), 
80, 1.20),
...
((SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "ATE-2025-4010"), 
(SELECT id_cliente FROM CLIENTE WHERE id_cliente = "CLI-2025-4318")),

((SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "ATE-2025-4010"), 
(SELECT id_cliente FROM CLIENTE WHERE id_cliente = "CLI-2025-7784")),

((SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "MOT-2025-1270"), 
(SELECT id_cliente FROM CLIENTE WHERE id_cliente = "CLI-2025-5968")),

((SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "COL-2025-5764"), 
(SELECT id_cliente FROM CLIENTE WHERE id_cliente = "CLI-2025-6490")),

((SELECT id_funcionario FROM Funcionario WHERE id_funcionario = "SEP-2025-6260"), 
(SELECT id_cliente FROM CLIENTE WHERE id_cliente = "CLI-2025-4544"));
